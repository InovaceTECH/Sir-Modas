...
export default async function DashboardPage({ searchParams }: { searchParams: Promise<{ periodo?: string }> }) {
  ...
  return <><PageHeader title="Olá! Veja como a loja está" description="Vendas, estoque, fiado e financeiro em uma visão rápida." action={<Link href="/vendas/nova" className="ui-button-primary"><Plus size={18} /> Registrar venda</Link>} />
